...
Analýzovaný problém
V éře streamování mohou být celkové počty přehrání zavádějící kvůli rozdílným délkám alb a vlivu virálních singlů. Cílem bylo normalizovat výkon pomocí „Hustoty hitů“ (streamy na minutu) a „Dominance hlavního singlu“, aby bylo možné identifikovat, které projekty jsou skutečně ucelené a které spoléhají na jeden masivní hit.

Klíčová zjištění a dashboard
...
Plný, komentovaný SQL skript si můžete prohlédnout v souboru post_malone_analysis.sql.
